...
export const MODULES: Record<ModuleKey, ModuleDef> = {
  ...
  todo: {
    key: "todo",
    label: "Today",
    description: "The day's work for your department",
    icon: ListChecks,
    // Sits with the operational modules rather than in a group of its own —
    // the day's work belongs beside the work.
    group: "operations",
    root: "/todo",
    nav: [{ href: "/todo", label: "Today", icon: ListChecks }],
    pathPrefixes: ["/todo"],
    minLevel: "view",
    sortOrder: 15,
  },
  ...
  procurement: {
    ...
    nav: [
      ...
      { href: "/procurement/prices", label: "Supplier prices", icon: Tag, short: "Prices" },
