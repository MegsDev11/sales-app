...
/**
 * Requests submitted from client installation QR codes.
 *
 * This page was once removed in favour of Messages, but the QR portal kept
 * writing client_support_requests — with no reader, a client's "no internet"
 * went into a table nobody saw and its status never moved off Submitted.
 * Restored so the loop closes: triage the request, or send it straight to
 * coordination as a service call.
 */
